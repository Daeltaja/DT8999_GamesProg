...
public class Perception : MonoBehaviour {
	...
	void FieldOfView() //if you want to spot a target within a specific angle, or cone of vision
	{
		Vector3 forwardDirection = transform.TransformDirection(Vector3.right); //give our player a default facing direction, change this is you like! It updates with it's rotation
